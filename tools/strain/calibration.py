...
Known limitation: The sigmoid calibration maps z=0 to 0.5, so the
discipline-specific thresholds (set for raw score ranges) don't align
with calibrated output ranges. Threshold recalibration against sigmoid
output space is needed before publishing results. See DESIGN.md S4.

See DESIGN.md S4 for the full calibration strategy.
"""
