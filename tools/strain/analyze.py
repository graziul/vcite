...
from calibration import calibrate_score, get_profile, classify_calibrated
...
def main():
    ...
    parser.add_argument(
        "--discipline",
        choices=list(get_profile("").name for _ in [""]) or [
            "hard_science", "social_science", "humanities",
            "legal", "journalism", "ai_output",
        ],
        default="",
